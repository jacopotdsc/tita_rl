...
parent_dir = os.path.dirname(script_dir)          # 1 level up
grandparent_dir = os.path.dirname(parent_dir)     # 2 levels up
...
if __name__ == '__main__':
    ...
    # Register tasks
    task_registry.register("tita_constraint", LeggedMPCRobot, TitaConstraintRoughCfg(), TitaConstraintRoughCfgPPO())

    args = get_args()
    args.task = "tita_constraint"
